...
func (o *Workitemqueryjobsort) SetField(field string, fieldValue interface{}) {
...
func (o Workitemqueryjobsort) MarshalJSON() ([]byte, error) {
...
func (o *Workitemqueryjobsort) UnmarshalJSON(b []byte) error {
	var WorkitemqueryjobsortMap map[string]interface{}
	err := json.Unmarshal(b, &WorkitemqueryjobsortMap)
	if err != nil {
		return err
	}
	
	if Name, ok := WorkitemqueryjobsortMap["name"].(string); ok {
		o.Name = &Name
	}
