...
func (o *Queryagentschedulingpreferencesrequest) SetField(field string, fieldValue interface{}) {
...
func (o Queryagentschedulingpreferencesrequest) MarshalJSON() ([]byte, error) {
...
func (o *Queryagentschedulingpreferencesrequest) UnmarshalJSON(b []byte) error {
	var QueryagentschedulingpreferencesrequestMap map[string]interface{}
	err := json.Unmarshal(b, &QueryagentschedulingpreferencesrequestMap)
	if err != nil {
		return err
	}
	
	if startDateString, ok := QueryagentschedulingpreferencesrequestMap["startDate"].(string); ok {
		StartDate, _ := time.Parse("2006-01-02T15:04:05.999999Z", startDateString)
		o.StartDate = &StartDate
	}
	
	if endDateString, ok := QueryagentschedulingpreferencesrequestMap["endDate"].(string); ok {
