...
func (o *Checklistfinalizepayload) SetField(field string, fieldValue interface{}) {
...
func (o Checklistfinalizepayload) MarshalJSON() ([]byte, error) {
...
func (o *Checklistfinalizepayload) UnmarshalJSON(b []byte) error {
	var ChecklistfinalizepayloadMap map[string]interface{}
	err := json.Unmarshal(b, &ChecklistfinalizepayloadMap)
	if err != nil {
		return err
	}
