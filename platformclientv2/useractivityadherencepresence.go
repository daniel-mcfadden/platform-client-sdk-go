...
type Useractivityadherencepresence struct { 
	...
	PresenceDefinition *Useractivitypresencedefinition `json:"presenceDefinition,omitempty"`
...
func (o *Useractivityadherencepresence) SetField(field string, fieldValue interface{}) {
...
func (o Useractivityadherencepresence) MarshalJSON() ([]byte, error) {
...
func (o *Useractivityadherencepresence) UnmarshalJSON(b []byte) error {
	var UseractivityadherencepresenceMap map[string]interface{}
	err := json.Unmarshal(b, &UseractivityadherencepresenceMap)
	if err != nil {
		return err
	}
	
	if PresenceDefinition, ok := UseractivityadherencepresenceMap["presenceDefinition"].(map[string]interface{}); ok {
		PresenceDefinitionString, _ := json.Marshal(PresenceDefinition)
		json.Unmarshal(PresenceDefinitionString, &o.PresenceDefinition)
	}
	
	if PresenceMessage, ok := UseractivityadherencepresenceMap["presenceMessage"].(string); ok {
		o.PresenceMessage = &PresenceMessage
	}
    
	if modifiedDateString, ok := UseractivityadherencepresenceMap["modifiedDate"].(string); ok {
