...
func (o Registerarchitectjobrequest) MarshalJSON() ([]byte, error) {
...
func (o *Registerarchitectjobrequest) UnmarshalJSON(b []byte) error {
	var RegisterarchitectjobrequestMap map[string]interface{}
	err := json.Unmarshal(b, &RegisterarchitectjobrequestMap)
	if err != nil {
		return err
	}
