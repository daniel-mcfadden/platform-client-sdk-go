...
// DeleteOutboundSchedulesWhatsappcampaign invokes DELETE /api/v2/outbound/schedules/whatsappcampaigns/{whatsAppCampaignId}
//
// Delete a WhatsApp campaign schedule.
func (a OutboundApi) DeleteOutboundSchedulesWhatsappcampaign(whatsAppCampaignId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/outbound/schedules/whatsappcampaigns/{whatsAppCampaignId}"
	path = strings.Replace(path, "{whatsAppCampaignId}", url.PathEscape(fmt.Sprintf("%v", whatsAppCampaignId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}

	// verify the required parameter 'whatsAppCampaignId' is set
	if &whatsAppCampaignId == nil {
		// false
		return nil, errors.New("Missing required parameter 'whatsAppCampaignId' when calling OutboundApi->DeleteOutboundSchedulesWhatsappcampaign")
	}
...
// GetOutboundCampaignSkillcombinations invokes GET /api/v2/outbound/campaigns/{campaignId}/skillcombinations
//
// Get the remaining and total contact count for each skill combination in a skills campaign
func (a OutboundApi) GetOutboundCampaignSkillcombinations(campaignId string, pageNumber int, pageSize int) (*Pagedskillcombinationlisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/outbound/campaigns/{campaignId}/skillcombinations"
	path = strings.Replace(path, "{campaignId}", url.PathEscape(fmt.Sprintf("%v", campaignId)), -1)
	defaultReturn := new(Pagedskillcombinationlisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &campaignId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'campaignId' when calling OutboundApi->GetOutboundCampaignSkillcombinations")
	}
	...
	var successPayload *Pagedskillcombinationlisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Pagedskillcombinationlisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetOutboundContactlistContactsBulkJob invokes GET /api/v2/outbound/contactlists/{contactListId}/contacts/bulk/jobs/{jobId}
//
// Get bulk operation job.
func (a OutboundApi) GetOutboundContactlistContactsBulkJob(contactListId string, jobId string) (*Contactsbulkoperationjob, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/outbound/contactlists/{contactListId}/contacts/bulk/jobs/{jobId}"
	path = strings.Replace(path, "{contactListId}", url.PathEscape(fmt.Sprintf("%v", contactListId)), -1)
	...
	if &contactListId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'contactListId' when calling OutboundApi->GetOutboundContactlistContactsBulkJob")
	}
	// verify the required parameter 'jobId' is set
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling OutboundApi->GetOutboundContactlistContactsBulkJob")
	}
...
// GetOutboundContactlistContactsBulkJobs invokes GET /api/v2/outbound/contactlists/{contactListId}/contacts/bulk/jobs
//
// Get 10 most recent bulk operation jobs associated with contact list.
func (a OutboundApi) GetOutboundContactlistContactsBulkJobs(contactListId string) (*Contactsbulkoperationjoblisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/outbound/contactlists/{contactListId}/contacts/bulk/jobs"
	path = strings.Replace(path, "{contactListId}", url.PathEscape(fmt.Sprintf("%v", contactListId)), -1)
	defaultReturn := new(Contactsbulkoperationjoblisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &contactListId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'contactListId' when calling OutboundApi->GetOutboundContactlistContactsBulkJobs")
	}
	...
	var successPayload *Contactsbulkoperationjoblisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Contactsbulkoperationjoblisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetOutboundDiagnosticsCampaignSummary invokes GET /api/v2/outbound/diagnostics/campaigns/{campaignId}/summary
//
// Get diagnostic summary for a single campaign
func (a OutboundApi) GetOutboundDiagnosticsCampaignSummary(campaignId string, start string, end string) (*Campaigndiagnosticsummary, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/outbound/diagnostics/campaigns/{campaignId}/summary"
	path = strings.Replace(path, "{campaignId}", url.PathEscape(fmt.Sprintf("%v", campaignId)), -1)
	defaultReturn := new(Campaigndiagnosticsummary)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &campaignId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'campaignId' when calling OutboundApi->GetOutboundDiagnosticsCampaignSummary")
	}
	// verify the required parameter 'start' is set
	if &start == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'start' when calling OutboundApi->GetOutboundDiagnosticsCampaignSummary")
	}
	// verify the required parameter 'end' is set
	if &end == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'end' when calling OutboundApi->GetOutboundDiagnosticsCampaignSummary")
	}
	...
	queryParams["start"] = a.Configuration.APIClient.ParameterToString(start, "")
	
	queryParams["end"] = a.Configuration.APIClient.ParameterToString(end, "")
	...
	var successPayload *Campaigndiagnosticsummary
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Campaigndiagnosticsummary" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetOutboundSchedulesWhatsappcampaign invokes GET /api/v2/outbound/schedules/whatsappcampaigns/{whatsAppCampaignId}
//
// Get a WhatsApp campaign schedule.
func (a OutboundApi) GetOutboundSchedulesWhatsappcampaign(whatsAppCampaignId string) (*Whatsappcampaignschedule, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/outbound/schedules/whatsappcampaigns/{whatsAppCampaignId}"
	path = strings.Replace(path, "{whatsAppCampaignId}", url.PathEscape(fmt.Sprintf("%v", whatsAppCampaignId)), -1)
	defaultReturn := new(Whatsappcampaignschedule)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &whatsAppCampaignId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'whatsAppCampaignId' when calling OutboundApi->GetOutboundSchedulesWhatsappcampaign")
	}
	...
	var successPayload *Whatsappcampaignschedule
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Whatsappcampaignschedule" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetOutboundSchedulesWhatsappcampaigns invokes GET /api/v2/outbound/schedules/whatsappcampaigns
//
// Query for a list of WhatsApp campaign schedules.
func (a OutboundApi) GetOutboundSchedulesWhatsappcampaigns() (*Whatsappcampaignscheduleentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/outbound/schedules/whatsappcampaigns"
	defaultReturn := new(Whatsappcampaignscheduleentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Whatsappcampaignscheduleentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Whatsappcampaignscheduleentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PatchOutboundCampaign invokes PATCH /api/v2/outbound/campaigns/{campaignId}
//
// Update a campaign.
func (a OutboundApi) PatchOutboundCampaign(campaignId string, body Campaignpatchrequest) (*APIResponse, error) {
	...
	if &campaignId == nil {
		// false
		return nil, errors.New("Missing required parameter 'campaignId' when calling OutboundApi->PatchOutboundCampaign")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return nil, errors.New("Missing required parameter 'body' when calling OutboundApi->PatchOutboundCampaign")
	}
...
// PostOutboundCampaignStart invokes POST /api/v2/outbound/campaigns/{campaignId}/start
//
// Start the campaign
func (a OutboundApi) PostOutboundCampaignStart(campaignId string) (*APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/outbound/campaigns/{campaignId}/start"
	path = strings.Replace(path, "{campaignId}", url.PathEscape(fmt.Sprintf("%v", campaignId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &campaignId == nil {
		// false
		return nil, errors.New("Missing required parameter 'campaignId' when calling OutboundApi->PostOutboundCampaignStart")
	}
...
// PostOutboundCampaignStop invokes POST /api/v2/outbound/campaigns/{campaignId}/stop
//
// Stop the campaign
func (a OutboundApi) PostOutboundCampaignStop(campaignId string) (*APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/outbound/campaigns/{campaignId}/stop"
	path = strings.Replace(path, "{campaignId}", url.PathEscape(fmt.Sprintf("%v", campaignId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &campaignId == nil {
		// false
		return nil, errors.New("Missing required parameter 'campaignId' when calling OutboundApi->PostOutboundCampaignStop")
	}
...
// PostOutboundCampaignsPerformanceQuery invokes POST /api/v2/outbound/campaigns/performance/query
//
// Get performance data for a list of campaigns
func (a OutboundApi) PostOutboundCampaignsPerformanceQuery(body []string) (*Campaignperformancedatalisting, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/outbound/campaigns/performance/query"
	defaultReturn := new(Campaignperformancedatalisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// true
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling OutboundApi->PostOutboundCampaignsPerformanceQuery")
	}
	...
	var successPayload *Campaignperformancedatalisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Campaignperformancedatalisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostOutboundContactlistsUploads invokes POST /api/v2/outbound/contactlists/uploads
//
// Generate presigned upload URL for contact list.
func (a OutboundApi) PostOutboundContactlistsUploads(body Contactlistuploadurlrequest) (*Uploadurlresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/outbound/contactlists/uploads"
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling OutboundApi->PostOutboundContactlistsUploads")
	}
...
// PostOutboundDnclistsUploads invokes POST /api/v2/outbound/dnclists/uploads
//
// Generate presigned upload URL for dnc list.
func (a OutboundApi) PostOutboundDnclistsUploads(body Dnclistuploadurlrequest) (*Uploadurlresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/outbound/dnclists/uploads"
	defaultReturn := new(Uploadurlresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling OutboundApi->PostOutboundDnclistsUploads")
	}
...
// PostOutboundMessagingcampaignStart invokes POST /api/v2/outbound/messagingcampaigns/{messagingCampaignId}/start
//
// Start the campaign
//
// Documented permissions are applicable based on campaign type.
func (a OutboundApi) PostOutboundMessagingcampaignStart(messagingCampaignId string) (*APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/outbound/messagingcampaigns/{messagingCampaignId}/start"
	path = strings.Replace(path, "{messagingCampaignId}", url.PathEscape(fmt.Sprintf("%v", messagingCampaignId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &messagingCampaignId == nil {
		// false
		return nil, errors.New("Missing required parameter 'messagingCampaignId' when calling OutboundApi->PostOutboundMessagingcampaignStart")
	}
...
// PostOutboundMessagingcampaignStop invokes POST /api/v2/outbound/messagingcampaigns/{messagingCampaignId}/stop
//
// Stop the campaign
//
// Documented permissions are applicable based on campaign type.
func (a OutboundApi) PostOutboundMessagingcampaignStop(messagingCampaignId string) (*APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/outbound/messagingcampaigns/{messagingCampaignId}/stop"
	path = strings.Replace(path, "{messagingCampaignId}", url.PathEscape(fmt.Sprintf("%v", messagingCampaignId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &messagingCampaignId == nil {
		// false
		return nil, errors.New("Missing required parameter 'messagingCampaignId' when calling OutboundApi->PostOutboundMessagingcampaignStop")
	}
...
// PutOutboundSchedulesWhatsappcampaign invokes PUT /api/v2/outbound/schedules/whatsappcampaigns/{whatsAppCampaignId}
//
// Update a WhatsApp campaign schedule.
func (a OutboundApi) PutOutboundSchedulesWhatsappcampaign(whatsAppCampaignId string, body Whatsappcampaignschedule) (*Whatsappcampaignschedule, *APIResponse, error) {
	var httpMethod = "PUT"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/outbound/schedules/whatsappcampaigns/{whatsAppCampaignId}"
	path = strings.Replace(path, "{whatsAppCampaignId}", url.PathEscape(fmt.Sprintf("%v", whatsAppCampaignId)), -1)
	...
	if &whatsAppCampaignId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'whatsAppCampaignId' when calling OutboundApi->PutOutboundSchedulesWhatsappcampaign")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling OutboundApi->PutOutboundSchedulesWhatsappcampaign")
	}
