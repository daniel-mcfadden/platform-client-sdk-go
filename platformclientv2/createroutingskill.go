...
func (o *Createroutingskill) SetField(field string, fieldValue interface{}) {
...
func (o Createroutingskill) MarshalJSON() ([]byte, error) {
...
func (o *Createroutingskill) UnmarshalJSON(b []byte) error {
	var CreateroutingskillMap map[string]interface{}
	err := json.Unmarshal(b, &CreateroutingskillMap)
	if err != nil {
		return err
	}
