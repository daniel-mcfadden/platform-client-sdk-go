...
func (o *Queuerequest) SetField(field string, fieldValue interface{}) {
...
func (o *Queuerequest) UnmarshalJSON(b []byte) error {
	...
	if UserMemberCount, ok := QueuerequestMap["userMemberCount"].(float64); ok {
	...
	if ConditionalGroupActivation, ok := QueuerequestMap["conditionalGroupActivation"].(map[string]interface{}); ok {
	...
	if MemberGroups, ok := QueuerequestMap["memberGroups"].([]interface{}); ok {
	...
	if EmailInQueueFlow, ok := QueuerequestMap["emailInQueueFlow"].(map[string]interface{}); ok {
		EmailInQueueFlowString, _ := json.Marshal(EmailInQueueFlow)
		json.Unmarshal(EmailInQueueFlowString, &o.EmailInQueueFlow)
	}
	
	if MessageInQueueFlow, ok := QueuerequestMap["messageInQueueFlow"].(map[string]interface{}); ok {
	...
	if OnHoldPrompt, ok := QueuerequestMap["onHoldPrompt"].(map[string]interface{}); ok {
		OnHoldPromptString, _ := json.Marshal(OnHoldPrompt)
		json.Unmarshal(OnHoldPromptString, &o.OnHoldPrompt)
	}
	
	if DefaultMediaLanguage, ok := QueuerequestMap["defaultMediaLanguage"].(string); ok {
	...
	if AgentOwnedRouting, ok := QueuerequestMap["agentOwnedRouting"].(map[string]interface{}); ok {
		AgentOwnedRoutingString, _ := json.Marshal(AgentOwnedRouting)
		json.Unmarshal(AgentOwnedRoutingString, &o.AgentOwnedRouting)
	}
	
	if DirectRouting, ok := QueuerequestMap["directRouting"].(map[string]interface{}); ok {
	...
	if SuppressInQueueCallRecording, ok := QueuerequestMap["suppressInQueueCallRecording"].(bool); ok {
