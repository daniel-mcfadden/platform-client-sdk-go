...
func (o *Checklistinferencejobpayload) SetField(field string, fieldValue interface{}) {
...
func (o Checklistinferencejobpayload) MarshalJSON() ([]byte, error) {
...
func (o *Checklistinferencejobpayload) UnmarshalJSON(b []byte) error {
	var ChecklistinferencejobpayloadMap map[string]interface{}
	err := json.Unmarshal(b, &ChecklistinferencejobpayloadMap)
	if err != nil {
		return err
	}
	
	if ConversationContext, ok := ChecklistinferencejobpayloadMap["conversationContext"].([]interface{}); ok {
