...
// DeleteFlowInstancesSettingsLoglevels invokes DELETE /api/v2/flows/{flowId}/instances/settings/loglevels
//
...
func (a ArchitectApi) DeleteFlowInstancesSettingsLoglevels(flowId string) (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/flows/{flowId}/instances/settings/loglevels"
	path = strings.Replace(path, "{flowId}", url.PathEscape(fmt.Sprintf("%v", flowId)), -1)
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &flowId == nil {
		// false
		return nil, errors.New("Missing required parameter 'flowId' when calling ArchitectApi->DeleteFlowInstancesSettingsLoglevels")
	}
...
// DeleteFlowsInstancesSettingsLoglevelsDefault invokes DELETE /api/v2/flows/instances/settings/loglevels/default
//
...
func (a ArchitectApi) DeleteFlowsInstancesSettingsLoglevelsDefault() (*APIResponse, error) {
	var httpMethod = "DELETE"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/flows/instances/settings/loglevels/default"
	if true == false {
		return nil, errors.New("This message brought to you by the laws of physics being broken")
	}
...
func (a ArchitectApi) GetArchitectIvrIdentityresolution(ivrId string) (*Ivridentityresolutionconfig, *APIResponse, error) {
	...
	if &ivrId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'ivrId' when calling ArchitectApi->GetArchitectIvrIdentityresolution")
	}
...
// GetFlowInstancesSettingsLoglevels invokes GET /api/v2/flows/{flowId}/instances/settings/loglevels
//
...
func (a ArchitectApi) GetFlowInstancesSettingsLoglevels(flowId string, expand []string) (*Flowsettingsresponse, *APIResponse, error) {
	...
	path := a.Configuration.BasePath + "/api/v2/flows/{flowId}/instances/settings/loglevels"
	path = strings.Replace(path, "{flowId}", url.PathEscape(fmt.Sprintf("%v", flowId)), -1)
	defaultReturn := new(Flowsettingsresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &flowId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'flowId' when calling ArchitectApi->GetFlowInstancesSettingsLoglevels")
	}
	...
	var successPayload *Flowsettingsresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Flowsettingsresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetFlowsExportJob invokes GET /api/v2/flows/export/jobs/{jobId}
//
// Fetch Architect Export Job Status
func (a ArchitectApi) GetFlowsExportJob(jobId string, expand []string) (*Architectexportjobstateresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/flows/export/jobs/{jobId}"
	path = strings.Replace(path, "{jobId}", url.PathEscape(fmt.Sprintf("%v", jobId)), -1)
	defaultReturn := new(Architectexportjobstateresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling ArchitectApi->GetFlowsExportJob")
	}
	...
	var successPayload *Architectexportjobstateresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Architectexportjobstateresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetFlowsInstancesSettingsExecutiondata invokes GET /api/v2/flows/instances/settings/executiondata
//
...
func (a ArchitectApi) GetFlowsInstancesSettingsExecutiondata() (*Executiondataflowsettingsresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/flows/instances/settings/executiondata"
	defaultReturn := new(Executiondataflowsettingsresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Executiondataflowsettingsresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Executiondataflowsettingsresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetFlowsInstancesSettingsLoglevels invokes GET /api/v2/flows/instances/settings/loglevels
//
...
func (a ArchitectApi) GetFlowsInstancesSettingsLoglevels(expand []string, pageNumber int, pageSize int) (*Flowsettingsresponseentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/flows/instances/settings/loglevels"
	defaultReturn := new(Flowsettingsresponseentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Flowsettingsresponseentitylisting
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Flowsettingsresponseentitylisting" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetFlowsInstancesSettingsLoglevelsCharacteristics invokes GET /api/v2/flows/instances/settings/loglevels/characteristics
//
...
func (a ArchitectApi) GetFlowsInstancesSettingsLoglevelsCharacteristics() (*Flowloglevelcharacteristicsdefinitions, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/flows/instances/settings/loglevels/characteristics"
	defaultReturn := new(Flowloglevelcharacteristicsdefinitions)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	var successPayload *Flowloglevelcharacteristicsdefinitions
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Flowloglevelcharacteristicsdefinitions" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// GetFlowsInstancesSettingsLoglevelsDefault invokes GET /api/v2/flows/instances/settings/loglevels/default
//
...
// GetFlowsLookup invokes GET /api/v2/flows/lookup
//
// Look up flows by ID
//
// Returns only flows matching the specified ID(s). Returns an empty listing if no flows match the given IDs.
func (a ArchitectApi) GetFlowsLookup(id []string, pageNumber int, pageSize int, sortBy string, sortOrder string) (*Flowentitylisting, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/flows/lookup"
	defaultReturn := new(Flowentitylisting)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &id == nil {
		// true
		return defaultReturn, nil, errors.New("Missing required parameter 'id' when calling ArchitectApi->GetFlowsLookup")
	}
...
// GetFlowsValidateJob invokes GET /api/v2/flows/validate/jobs/{jobId}
//
// Fetch Architect Validate Job Status
//
// Preview: GetFlowsValidateJob is a preview method and is subject to both breaking and non-breaking changes at any time without notice
func (a ArchitectApi) GetFlowsValidateJob(jobId string, expand []string) (*Architectvalidatejobstateresponse, *APIResponse, error) {
	var httpMethod = "GET"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/flows/validate/jobs/{jobId}"
	path = strings.Replace(path, "{jobId}", url.PathEscape(fmt.Sprintf("%v", jobId)), -1)
	defaultReturn := new(Architectvalidatejobstateresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &jobId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'jobId' when calling ArchitectApi->GetFlowsValidateJob")
	}
	...
	var successPayload *Architectvalidatejobstateresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Architectvalidatejobstateresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PatchFlowsInstancesSettingsExecutiondata invokes PATCH /api/v2/flows/instances/settings/executiondata
//
...
func (a ArchitectApi) PatchFlowsInstancesSettingsExecutiondata(body Executiondatasettingsrequest) (*Executiondataflowsettingsresponse, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ArchitectApi->PatchFlowsInstancesSettingsExecutiondata")
	}
...
func (a ArchitectApi) PostArchitectPromptResourceUploads(promptId string, languageCode string) (*Promptassetupload, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/architect/prompts/{promptId}/resources/{languageCode}/uploads"
	path = strings.Replace(path, "{promptId}", url.PathEscape(fmt.Sprintf("%v", promptId)), -1)
	path = strings.Replace(path, "{languageCode}", url.PathEscape(fmt.Sprintf("%v", languageCode)), -1)
	defaultReturn := new(Promptassetupload)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &promptId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'promptId' when calling ArchitectApi->PostArchitectPromptResourceUploads")
	}
	// verify the required parameter 'languageCode' is set
	if &languageCode == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'languageCode' when calling ArchitectApi->PostArchitectPromptResourceUploads")
	}
	...
	var successPayload *Promptassetupload
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
...
func (a ArchitectApi) PostArchitectSystempromptResourceUploads(promptId string, languageCode string) (*Promptassetupload, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/architect/systemprompts/{promptId}/resources/{languageCode}/uploads"
	path = strings.Replace(path, "{promptId}", url.PathEscape(fmt.Sprintf("%v", promptId)), -1)
	path = strings.Replace(path, "{languageCode}", url.PathEscape(fmt.Sprintf("%v", languageCode)), -1)
	defaultReturn := new(Promptassetupload)
	if true == false {
	...
	if &promptId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'promptId' when calling ArchitectApi->PostArchitectSystempromptResourceUploads")
	}
	// verify the required parameter 'languageCode' is set
	if &languageCode == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'languageCode' when calling ArchitectApi->PostArchitectSystempromptResourceUploads")
	}
...
// PostFlowInstancesSettingsLoglevels invokes POST /api/v2/flows/{flowId}/instances/settings/loglevels
//
...
func (a ArchitectApi) PostFlowInstancesSettingsLoglevels(flowId string, body Flowloglevelrequest, expand []string) (*Flowsettingsresponse, *APIResponse, error) {
	...
	if &flowId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'flowId' when calling ArchitectApi->PostFlowInstancesSettingsLoglevels")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ArchitectApi->PostFlowInstancesSettingsLoglevels")
	}
...
// PostFlowsDatatableImportCsvJobs invokes POST /api/v2/flows/datatables/{datatableId}/import/csv/jobs
//
...
func (a ArchitectApi) PostFlowsDatatableImportCsvJobs(datatableId string, body Datatableimportjob) (*Datatableimportjob, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/flows/datatables/{datatableId}/import/csv/jobs"
	path = strings.Replace(path, "{datatableId}", url.PathEscape(fmt.Sprintf("%v", datatableId)), -1)
	defaultReturn := new(Datatableimportjob)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	...
	if &datatableId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'datatableId' when calling ArchitectApi->PostFlowsDatatableImportCsvJobs")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ArchitectApi->PostFlowsDatatableImportCsvJobs")
	}
...
//
// Deprecated: PostFlowsDatatableImportJobs is deprecated
...
// PostFlowsExportJobs invokes POST /api/v2/flows/export/jobs
//
// Register Architect Export Job
func (a ArchitectApi) PostFlowsExportJobs(body Registerarchitectexportjob) (*Registerarchitectexportjobresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/flows/export/jobs"
	defaultReturn := new(Registerarchitectexportjobresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ArchitectApi->PostFlowsExportJobs")
	}
	...
	var successPayload *Registerarchitectexportjobresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Registerarchitectexportjobresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
// PostFlowsValidateJobs invokes POST /api/v2/flows/validate/jobs
//
// Register Architect Validate Job
//
// Preview: PostFlowsValidateJobs is a preview method and is subject to both breaking and non-breaking changes at any time without notice
func (a ArchitectApi) PostFlowsValidateJobs(body Registerarchitectvalidatejob) (*Registerarchitectvalidatejobresponse, *APIResponse, error) {
	var httpMethod = "POST"
	// create path and map variables
	path := a.Configuration.BasePath + "/api/v2/flows/validate/jobs"
	defaultReturn := new(Registerarchitectvalidatejobresponse)
	if true == false {
		return defaultReturn, nil, errors.New("This message brought to you by the laws of physics being broken")
	}
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ArchitectApi->PostFlowsValidateJobs")
	}
	...
	var successPayload *Registerarchitectvalidatejobresponse
	response, err := a.Configuration.APIClient.CallAPI(path, httpMethod, postBody, headerParams, queryParams, formParams, postFileName, fileBytes, "other")
	if err != nil {
		// Nothing special to do here, but do avoid processing the response
	} else if err == nil && response.Error != nil {
		...
		if "Registerarchitectvalidatejobresponse" == "string" {
			copy(response.RawBody, &successPayload)
		} else {
			err = json.Unmarshal(response.RawBody, &successPayload)
		}
...
func (a ArchitectApi) PutArchitectIvrIdentityresolution(ivrId string, body Ivridentityresolutionconfig) (*Ivridentityresolutionconfig, *APIResponse, error) {
	...
	if &ivrId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'ivrId' when calling ArchitectApi->PutArchitectIvrIdentityresolution")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ArchitectApi->PutArchitectIvrIdentityresolution")
	}
...
// PutFlowInstancesSettingsLoglevels invokes PUT /api/v2/flows/{flowId}/instances/settings/loglevels
//
...
func (a ArchitectApi) PutFlowInstancesSettingsLoglevels(flowId string, body Flowloglevelrequest, expand []string) (*Flowsettingsresponse, *APIResponse, error) {
	...
	if &flowId == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'flowId' when calling ArchitectApi->PutFlowInstancesSettingsLoglevels")
	}
	// verify the required parameter 'body' is set
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ArchitectApi->PutFlowInstancesSettingsLoglevels")
	}
...
// PutFlowsInstancesSettingsLoglevelsDefault invokes PUT /api/v2/flows/instances/settings/loglevels/default
//
...
func (a ArchitectApi) PutFlowsInstancesSettingsLoglevelsDefault(body Flowloglevelrequest, expand []string) (*Flowsettingsresponse, *APIResponse, error) {
	...
	if &body == nil {
		// false
		return defaultReturn, nil, errors.New("Missing required parameter 'body' when calling ArchitectApi->PutFlowsInstancesSettingsLoglevelsDefault")
	}
