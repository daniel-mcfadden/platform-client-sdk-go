...
func (o *Queuefullreference) SetField(field string, fieldValue interface{}) {
...
func (o Queuefullreference) MarshalJSON() ([]byte, error) {
...
func (o *Queuefullreference) UnmarshalJSON(b []byte) error {
	var QueuefullreferenceMap map[string]interface{}
	err := json.Unmarshal(b, &QueuefullreferenceMap)
	if err != nil {
		return err
	}
	
	if Id, ok := QueuefullreferenceMap["id"].(string); ok {
		o.Id = &Id
	}
    
	if Name, ok := QueuefullreferenceMap["name"].(string); ok {
		o.Name = &Name
	}
    
	if Division, ok := QueuefullreferenceMap["division"].(map[string]interface{}); ok {
		DivisionString, _ := json.Marshal(Division)
		json.Unmarshal(DivisionString, &o.Division)
	}
	
	if Description, ok := QueuefullreferenceMap["description"].(string); ok {
		o.Description = &Description
	}
    
	if dateCreatedString, ok := QueuefullreferenceMap["dateCreated"].(string); ok {
		DateCreated, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateCreatedString)
		o.DateCreated = &DateCreated
	}
	
	if dateModifiedString, ok := QueuefullreferenceMap["dateModified"].(string); ok {
		DateModified, _ := time.Parse("2006-01-02T15:04:05.999999Z", dateModifiedString)
		o.DateModified = &DateModified
	}
	
	if ModifiedBy, ok := QueuefullreferenceMap["modifiedBy"].(string); ok {
		o.ModifiedBy = &ModifiedBy
	}
    
	if CreatedBy, ok := QueuefullreferenceMap["createdBy"].(string); ok {
		o.CreatedBy = &CreatedBy
	}
    
	if MemberCount, ok := QueuefullreferenceMap["memberCount"].(float64); ok {
		MemberCountInt := int(MemberCount)
		o.MemberCount = &MemberCountInt
	}
	
	if UserMemberCount, ok := QueuefullreferenceMap["userMemberCount"].(float64); ok {
		UserMemberCountInt := int(UserMemberCount)
		o.UserMemberCount = &UserMemberCountInt
	}
	
	if JoinedMemberCount, ok := QueuefullreferenceMap["joinedMemberCount"].(float64); ok {
		JoinedMemberCountInt := int(JoinedMemberCount)
		o.JoinedMemberCount = &JoinedMemberCountInt
	}
	
	if MediaSettings, ok := QueuefullreferenceMap["mediaSettings"].(map[string]interface{}); ok {
		MediaSettingsString, _ := json.Marshal(MediaSettings)
		json.Unmarshal(MediaSettingsString, &o.MediaSettings)
	}
	
	if RoutingRules, ok := QueuefullreferenceMap["routingRules"].([]interface{}); ok {
		RoutingRulesString, _ := json.Marshal(RoutingRules)
		json.Unmarshal(RoutingRulesString, &o.RoutingRules)
	}
	
	if ConditionalGroupRouting, ok := QueuefullreferenceMap["conditionalGroupRouting"].(map[string]interface{}); ok {
	...
	if ConditionalGroupActivation, ok := QueuefullreferenceMap["conditionalGroupActivation"].(map[string]interface{}); ok {
	...
	if Bullseye, ok := QueuefullreferenceMap["bullseye"].(map[string]interface{}); ok {
		BullseyeString, _ := json.Marshal(Bullseye)
		json.Unmarshal(BullseyeString, &o.Bullseye)
	}
	
	if ScoringMethod, ok := QueuefullreferenceMap["scoringMethod"].(string); ok {
		o.ScoringMethod = &ScoringMethod
	}
    
	if LastAgentRoutingMode, ok := QueuefullreferenceMap["lastAgentRoutingMode"].(string); ok {
		o.LastAgentRoutingMode = &LastAgentRoutingMode
	}
    
	if AcwSettings, ok := QueuefullreferenceMap["acwSettings"].(map[string]interface{}); ok {
		AcwSettingsString, _ := json.Marshal(AcwSettings)
		json.Unmarshal(AcwSettingsString, &o.AcwSettings)
	}
	
	if SkillEvaluationMethod, ok := QueuefullreferenceMap["skillEvaluationMethod"].(string); ok {
		o.SkillEvaluationMethod = &SkillEvaluationMethod
	}
    
	if MemberGroups, ok := QueuefullreferenceMap["memberGroups"].([]interface{}); ok {
		MemberGroupsString, _ := json.Marshal(MemberGroups)
		json.Unmarshal(MemberGroupsString, &o.MemberGroups)
	}
	
	if QueueFlow, ok := QueuefullreferenceMap["queueFlow"].(map[string]interface{}); ok {
		QueueFlowString, _ := json.Marshal(QueueFlow)
		json.Unmarshal(QueueFlowString, &o.QueueFlow)
	}
	
	if EmailInQueueFlow, ok := QueuefullreferenceMap["emailInQueueFlow"].(map[string]interface{}); ok {
		EmailInQueueFlowString, _ := json.Marshal(EmailInQueueFlow)
		json.Unmarshal(EmailInQueueFlowString, &o.EmailInQueueFlow)
	}
	
	if MessageInQueueFlow, ok := QueuefullreferenceMap["messageInQueueFlow"].(map[string]interface{}); ok {
		MessageInQueueFlowString, _ := json.Marshal(MessageInQueueFlow)
		json.Unmarshal(MessageInQueueFlowString, &o.MessageInQueueFlow)
	}
	
	if WhisperPrompt, ok := QueuefullreferenceMap["whisperPrompt"].(map[string]interface{}); ok {
		WhisperPromptString, _ := json.Marshal(WhisperPrompt)
		json.Unmarshal(WhisperPromptString, &o.WhisperPrompt)
	}
	
	if OnHoldPrompt, ok := QueuefullreferenceMap["onHoldPrompt"].(map[string]interface{}); ok {
		OnHoldPromptString, _ := json.Marshal(OnHoldPrompt)
		json.Unmarshal(OnHoldPromptString, &o.OnHoldPrompt)
	}
	
	if DefaultMediaLanguage, ok := QueuefullreferenceMap["defaultMediaLanguage"].(string); ok {
		o.DefaultMediaLanguage = &DefaultMediaLanguage
	}
    
	if AutoAnswerOnly, ok := QueuefullreferenceMap["autoAnswerOnly"].(bool); ok {
		o.AutoAnswerOnly = &AutoAnswerOnly
	}
    
	if CannedResponseLibraries, ok := QueuefullreferenceMap["cannedResponseLibraries"].(map[string]interface{}); ok {
	...
	if EnableTranscription, ok := QueuefullreferenceMap["enableTranscription"].(bool); ok {
		o.EnableTranscription = &EnableTranscription
	}
    
	if EnableAudioMonitoring, ok := QueuefullreferenceMap["enableAudioMonitoring"].(bool); ok {
		o.EnableAudioMonitoring = &EnableAudioMonitoring
	}
    
	if EnableManualAssignment, ok := QueuefullreferenceMap["enableManualAssignment"].(bool); ok {
		o.EnableManualAssignment = &EnableManualAssignment
	}
    
	if AgentOwnedRouting, ok := QueuefullreferenceMap["agentOwnedRouting"].(map[string]interface{}); ok {
		AgentOwnedRoutingString, _ := json.Marshal(AgentOwnedRouting)
		json.Unmarshal(AgentOwnedRoutingString, &o.AgentOwnedRouting)
	}
	
	if DirectRouting, ok := QueuefullreferenceMap["directRouting"].(map[string]interface{}); ok {
		DirectRoutingString, _ := json.Marshal(DirectRouting)
		json.Unmarshal(DirectRoutingString, &o.DirectRouting)
	}
	
	if CallingPartyName, ok := QueuefullreferenceMap["callingPartyName"].(string); ok {
		o.CallingPartyName = &CallingPartyName
	}
    
	if CallingPartyNumber, ok := QueuefullreferenceMap["callingPartyNumber"].(string); ok {
		o.CallingPartyNumber = &CallingPartyNumber
	}
    
	if DefaultScripts, ok := QueuefullreferenceMap["defaultScripts"].(map[string]interface{}); ok {
		DefaultScriptsString, _ := json.Marshal(DefaultScripts)
		json.Unmarshal(DefaultScriptsString, &o.DefaultScripts)
	}
	
	if OutboundMessagingAddresses, ok := QueuefullreferenceMap["outboundMessagingAddresses"].(map[string]interface{}); ok {
	...
	if OutboundEmailAddress, ok := QueuefullreferenceMap["outboundEmailAddress"].(map[string]interface{}); ok {
	...
	if PeerId, ok := QueuefullreferenceMap["peerId"].(string); ok {
		o.PeerId = &PeerId
	}
    
	if SuppressInQueueCallRecording, ok := QueuefullreferenceMap["suppressInQueueCallRecording"].(bool); ok {
		o.SuppressInQueueCallRecording = &SuppressInQueueCallRecording
	}
    
	if SelfUri, ok := QueuefullreferenceMap["selfUri"].(string); ok {
		o.SelfUri = &SelfUri
	}
