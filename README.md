...
Latest version: 199.0.0 [![GitHub release](https://img.shields.io/github/release/mypurecloud/platform-client-sdk-go.svg)](https://github.com/MyPureCloud/platform-client-sdk-go)
...
```go
go get github.com/mypurecloud/platform-client-sdk-go/v199/platformclientv2
```
